...
import ConfirmModal from "../modals/ConfirmModals"; // Pastikan nama file (ConfirmModals.jsx) sesuai
...
export default function RecipeDetail({
  ...
  // ===================================================================
  // PERBAIKAN: SEMUA HOOKS HARUS DIPANGGIL DI ATAS (SEBELUM RETURN)
  // ===================================================================
  const {
    recipe,
  ...
  // Gunakan optional chaining (?) untuk mencegah error jika recipe masih null
  const recipeCategory = recipe?.category || category;
  const colors = categoryColors[recipeCategory] || categoryColors.makanan;

  // --- GUARD CLAUSES (PENJAGA) SEKARANG AMAN DIGUNAKAN ---
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div
            className={`animate-spin rounded-full h-12 w-12 border-b-2 border-${fallbackColor.primary}-600 mx-auto`}
          ></div>
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border border-white/40 mb-8">
          <div className="relative h-64 md:h-96 overflow-hidden">
            ...
            <div className="absolute bottom-4 left-4">
              <span
                className={`${colors.text} ${colors.bg} px-4 py-2 rounded-full text-sm font-semibold capitalize`}
              >
                {recipe.category}
              </span>
            </div>
